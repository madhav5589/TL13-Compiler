...
#line 90 "parse.tab.c" /* yacc.c:339  */
...
#line 179 "parse.tab.c" /* yacc.c:358  */
...
{
       0,    47,    47,    58,    59,    62,    63,    66,    67,    70,
      71,    72,    73,    76,    77,    80,    83,    84,    87,    90,
      93,    94,    97,    98,   101,   102,   105,   106,   110,   111
};
#endif
...
{
  "$end", "error", "$undefined", "num", "boollit", "OP2", "OP3", "OP4",
  "ident", "LP", "RP", "ASGN", "SC", "INT", "BOOL", "IF", "THEN", "ELSE",
  "BEGIN_STMT", "END", "WHILE", "DO", "PROGRAM", "VAR", "AS", "WRITEINT",
...
{
     -14,   -13,    15,     9,     4,   -33,    -5,     1,    -1,    16,
      21,    21,    21,    12,    20,   -33,   -33,   -33,   -33,   -33,
     -33,    22,    -3,   -33,   -33,   -33,    21,    17,    28,    30,
      23,    18,   -33,   -33,     1,   -13,   -33,   -33,    27,     1,
      21,    21,    21,     1,   -33,   -33,   -33,    24,   -33,   -33,
     -33,    19,     1,    25,   -33,   -33,   -33
};
...
{
      23,    24,    44,    31,    32,    25,    26,    47,     1,     9,
       3,    51,    19,    20,    37,     5,    10,     6,    38,     8,
      55,    11,     7,    36,    23,    24,    12,    22,    42,    25,
      26,    33,    34,    39,    35,    40,    41,    46,    54,    43,
      45,    52,    48,     0,    56,    50,     0,    49
};

static const yytype_int8 yycheck[] =
{
       3,     4,    34,    11,    12,     8,     9,    39,    22,     8,
      23,    43,    13,    14,    22,     0,    15,     8,    26,    24,
      52,    20,    18,    26,     3,     4,    25,    11,     5,     8,
       9,    19,    12,    16,    12,     7,     6,    10,    19,    21,
      35,    17,    40,    -1,    19,    42,    -1,    41
};
...
{
       0,    22,    28,    23,    29,     0,     8,    18,    24,     8,
      15,    20,    25,    31,    32,    33,    34,    36,    37,    13,
      14,    30,    11,     3,     4,     8,     9,    38,    39,    40,
      41,    38,    38,    19,    12,    12,    26,    38,    38,    16,
       7,     6,     5,    21,    31,    29,    10,    31,    39,    40,
...
#line 47 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = opr(PROGRAM, 3, (yyvsp[-3].nPtr), (yyvsp[-1].nPtr),str("end"));
	printf("\n-- Generated code -- \n\n");
...
#line 58 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = opr(AS, 4, (yyvsp[-2].nPtr),var((yyvsp[-4].sString)),opr(SC,0),(yyvsp[0].nPtr)); }
...
#line 59 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = NULL;  }
#line 1305 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 73 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = (yyvsp[0].nPtr); }
#line 1353 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 76 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = opr(ASGN, 2, var((yyvsp[-2].sString)), (yyvsp[0].nPtr)); }
#line 1359 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 77 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = opr(ASGN, 2, var((yyvsp[-2].sString)), opr(READINT,0)); }
#line 1365 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 80 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = opr(IF, 4, (yyvsp[-4].nPtr), (yyvsp[-2].nPtr), (yyvsp[-1].nPtr), str("end"));}
...
#line 1377 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 84 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = NULL; }
#line 1383 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 87 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = opr(WHILE, 3, (yyvsp[-3].nPtr), (yyvsp[-1].nPtr),str("end")); }
...
#line 1407 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 101 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = opr((yyvsp[-1].iValue), 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1425 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 105 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = var((yyvsp[0].sString)); }
...
#line 106 "parse.y" /* yacc.c:1646  */
    { (yyval.nPtr) = lit((yyvsp[0].iValue));
		if(!((yyvsp[0].iValue) >=-2147483647 && (yyvsp[0].iValue) <= 2147483647)) {
